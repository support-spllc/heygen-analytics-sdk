!function(window) {
  ...
  class HeyGenAnalyticsAvatar {
    ...
    async loadSDK() {
      ...
      script.src = "https://cdn.jsdelivr.net/npm/@heygen/streaming-avatar@latest/dist/index.js";
  ...
  console.log("🤖 HeyGen Analytics SDK loaded. Use window.HeyGenAnalytics to interact with your avatar.");
